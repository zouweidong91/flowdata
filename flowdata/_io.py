...
class ExcelTool:
    ...
    """
    @classmethod
    def read_list(cls, file_path, sheet_name='Sheet1', todict=True, fillna:bool=True):
    ...
    @classmethod
    def write(cls, item_list:List[dict], file_path, columns=None, key_map:dict=None, width=10):
        """_summary_
